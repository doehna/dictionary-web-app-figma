function e(e,t){let n=document.querySelector(".select").firstElementChild;n.innerHTML=e,n.style.fontFamily=t}function t(e){var t;t=e?"20px":"0px",(toggleButton=document.querySelector(".toggle-button")).style.transform=`translateX(${t})`}function n(e){let t=document.querySelector("html");t.classList.remove("sans-serif"),t.classList.remove("serif"),t.classList.remove("monospace"),t.classList.add(e),localStorage.setItem("fontFamily",e)}function o(e,t){let n=document.querySelector("html");n.classList.add(e),n.classList.remove(t)}function r(e){localStorage.setItem("theme",e)}function s(e,t){return e?`<div class="${t}">"${e}"</div>`:""}async function c(e){let t=document.querySelector(".search").value;if(document.querySelector(".content").innerHTML="",t){document.querySelector(".loader").classList.remove("hidden"),document.querySelector(".validation").classList.add("hidden"),document.querySelector(".search").classList.remove("error");try{let e=await fetch("https://api.dictionaryapi.dev/api/v2/entries/en/"+t).then(e=>{if(e.ok)return e.json();throw Error("Big error")}).then(e=>JSON.stringify(e)).catch(e=>{throw Error("Big error 2")});i(),function(e){let t;let n=JSON.parse(e);document.querySelector(".content").innerHTML=(t="",n.forEach(e=>{var n;let o;t+=`<article class="article">
        ...
        ${s(e.phonetic,"pronouncation")}
            ...
            <main class="definition">
                ${n=e.meanings,o="",n.forEach(e=>{var t,n;let r,c,i;o+=`<span class='part-of-speech'>
        ...
        <div class="meaning-container">
            ...
            <ul class="meaning">
                ${t=e.definitions,r="",t.forEach(e=>{e.definition&&(r+=`<li>
                ${e.definition}
            </li>
            ${s(e.example,"example")}`)}),r}
            </ul>
        </div>
